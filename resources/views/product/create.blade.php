<x-meta>
    ...
    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
        ...
        <div>
            <div>
                <label for="visitors" class="block mb-2.5 text-sm font-medium text-heading">{{ __('Code') }}</label>
                <input type="text" name="code" id="visitors"
            ...
            <div>
                ...
                <input type="number" name="quantity" id="visitors"
                    class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-2.5 py-2 shadow-xs placeholder:text-body"
                    placeholder="" required />
            </div>
            ...
            <div>
                ...
                <input type="text" name="price" id="visitors"
                    class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-2.5 py-2 shadow-xs placeholder:text-body"
                    placeholder="" required />
            </div>
            ...
            <ul class="select-none grid grid-cols-2 w-full gap-4 md:grid-cols-3 my-2">
                <li>
                    <input type="radio" id="react-option" value="male" name="category" class="hidden peer"
                        required="" checked>
                ...
                <li>
                    <input type="radio" id="vue-option" value="female" name="category" class="hidden peer">
        ...
        <button type="submit"
            class="text-white bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">Add</button>
    </form>
</x-meta>
